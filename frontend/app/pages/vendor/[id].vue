...
<template>
  <div class="space-y-12">
    ...
    <template v-else-if="vendor">
      ...
      <VendorsStorefrontHeader :vendor="vendor" />

      <!-- 2. Interactive Product Catalog (Grouped by Category) -->
      <VendorsProductCatalog :grouped-products="groupedProducts" :loading="loading" />

      <!-- 3. Storefront Reviews & Testimonials Ledger -->
      <VendorsStorefrontReviews :reviews="reviews" :loading="loading" />
    </template>
  </div>
</template>
